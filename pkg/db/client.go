...
import (
	...
	"github.com/geeksheik9/swim-CRUD/pkg/config"
...
func InitializeDatabases(client *mongo.Client, config *config.Config) *WorkoutDB {

	database := &WorkoutDB{
		client:        client,
		datbaseName:   config.Database,
		setCollection: config.SetCollection,
	}
